...
export const Footer = () => {
    return (
        <footer className='bg-green px-20 py-40'>
            <div className='border-b-[1px] mb-[20px] md:mb-[32px] lg:mb[40px] md:flex md:justify-between pb-[80px] md:pb-[88px] lg:pb-[64px]'>
                <div className='mb-[40px] md:mb-0'>
                    <Logo/>
                    <p className='w-[261px] lg:w-[311px] text-14 md:text-16 leading-128 font-normal text-gray'>Get the medicine to help you feel
                ...
                <div className=' md:flex md:flex-col md:gap-[32px]  lg:flex-row'>
                    <ul className='flex gap-[28px] md:gap-[32px] lg:gap-[50px]'>
                        ...
                        <Link to='/medicine-store' className='text-14 md:text-20 leading-128 font-normal text-gray'>Medicine
                            Store</Link>
                        <Link to='/medicine' className='text-14 md:text-20 leading-128 font-normal text-gray'>Medicine</Link>
                    </ul>
            ...
            <div>
                <div className='flex flex-wrap gap-[10px] md:gap-[24px] md:justify-center text-[10px] leading-100 md:text-14 md:leading-128 font-normal text-gray'>
