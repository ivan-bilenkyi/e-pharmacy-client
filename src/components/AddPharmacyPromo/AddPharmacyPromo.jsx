    ...
    return (
        <section className=''>
            <div className='px-20 py-40 md:px-[32px] flex flex-col items-center'>
                <div
                    className='w-[335px] md:w-[704px] bg-green rounded-[32px] p-20 md:py-[40px] md:px-[48px] text-subText flex flex-col gap-[19px]'>
                    <div>
                        <h2 className='text-28 leading-114 font-bold mb-[20px]'>Add the medicines you need online
                            now</h2>
                        ...
                        <Link to='/medicine-store'
                              className='inline-block px-[32px] py-[13px] mb-[20px] rounded-60 border border-grayAlpha text-14 leading-128 text-subText'>Buy
                            medicine</Link>
                    </div>
                    <div>
                        <picture>
